...
function handlePlayerLeave(socket, io) {
    ...
    if (roomData.gameData.host === socket.id) {
        ...
        if (nextHost) {
            ...
            // 🔧 【修正】最新100件のみ保持
            if (roomData.gameData.messages.length > 100) {
                roomData.gameData.messages = roomData.gameData.messages.slice(-100);
            }
